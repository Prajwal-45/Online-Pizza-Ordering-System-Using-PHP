<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">PizzaMax</a>
		      ...
		      <ul class="right hide-on-med-and-down">
		        ...
		        <li><a href="foods.php" class="hvr-grow">Types</a></li>
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +91-8080099658,+91-7709624862 Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/PizzaMax">Home</a></li>
	        <li><a href="/RestroGirls/about-restro-girls.php">About Us</a></li>
	        <li><a href="food-categories.php">Categories</a></li>
	        <li><a href="foods.php">Types</a></li>
	        <li><a href="#" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +91-8080099658,+91-7709624862. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
